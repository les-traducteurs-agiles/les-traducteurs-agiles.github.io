...
Le développement agile de produit est devenu la norme dans beaucoup d’industries (tout spécialement dans le domaine du logiciel). Cela signifie que les produits sont développées par des équipes réduites, auto-organisées, pluridisciplinaires, et sont livrés par petits incréments et améliorés constamment par rapport aux _feedbacks_ de vrais utilisateurs. En gros, tel que cela est décrit dans le manifeste agile - mais en remplaçant “logiciel” par “produit” (parce que cela n’est pas spécifique au domaine du logiciel).
...
Avant d’essayer de “gérer” cette complexité, demandez-vous d’avord **“est-ce que cela doit être obligatoirement aussi gros et aussi compliqué ?”**. Peut-être que vous êtes en train d’essayer de construire cet énorme éléphant en un seul jet. Peut-être que vos équipes est organisée par fonction, créant ainsi beaucoup de dépendances. Peut-être que votre architecture est-elle trop rigide, trop fragile, ou trop couplée.
...
Par conséquent, **commencez par simplifier les choses**. Un sage a dit “N’escaladez pas agile - désescaladez votre organisation”. Peut-être pouvez-vous réorganisez une ou deux équipes pour avoir juste le bon équilibre de compétences, co-localisées et 100% concentrées sur et avec le contact direct avec le client. Elles peuvent être tout à fait capable d’élaborer le même produit (ou même mieux) en la moitié moins de temps et pour la moitié moins de budget ! Ne tombez pas dans le piège mental de croire que plus de monde = mieux. Avoir plus de monde pourrait être mieux dans certains cas, mais la seule chose dont vous pouvez être certain à ce suejt est que **plus de monde = plus de budget et plus de complexité**. Les bénéfices potentiels sont, eh bien, uniquement des bénéfices potentiels.
...
Mais OK. **Quelques fois vous avez vraiment besoin d’avoir un gros tas d’équipes et de départements et de vendeurs pour collaborer sur quelque chose de gros et de complexe**. Disons simplement que c’est le cas. Je serai gentil et je vous donne le bénéfice du doute.
...
Au niveau de l’équipe, les méthodes agiles inclues déjà des rôles de leadership tels que Product Owner et Scrum Master. Mais au niveau multi-équipes, il n’y a pas de rôle formel de leader unique appointé. C’est parce que **de petits efforts ne nécessitent pas d’avoir un leader designé** - le succès de Scrum nous a montré qu’un leadership efficace peut se produire sans avoir un leader unique appointé. Toutefois, **plus il y a de personnes impliquées, plus il est probable que vous ayez besoin d’un leader dédié**, une personne à plein temps qui se focalise seulement là-dessus - peu importe que l’effort des multi-équipes se fasse dans un “projet”, un “programme”, un “pari”, un “produit” ou quoi que ce soit.
...
Le leader ne doit pas nécessairement être une seule personne, cela peut être un binôme, ou une équipe soudé - aussi longtemps qu’ils collaborent étroitement et qui parlent d’une seule voix. Dans le cadre de cet article, je partirai du principe qu’il s’agit d’une seule personne.
...
`_**Exemple** : À Spotify, la plupart des initiatives moyennes à larges sont conduites par un "trio TPD" - une équipe leadership réduite comprenant une personne de la Technique, une du Produit, et une du Design. De cette manière, chacun des trois points de vue sont toujours pris en compte. Toutefois, pour de vastes effrots qui vont au-delà de la technique et du produit et du design, ce trio est insuffisant. Devrions-nous étendre le trio, ou devrions-nous avoir un rôle de leader supplémentaire ? Et comment devrions-nous appeler un tel rôle ? Nous continuons à expérimenter là-dessus._`
