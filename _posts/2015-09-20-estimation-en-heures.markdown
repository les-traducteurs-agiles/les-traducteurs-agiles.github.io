...
Il y a eu une discussion la semaine dernière je crois sur la liste Yahoo(!) _scrumdevelopment_.
...
Christofer Jenning y demandait si les gens utilisaient l'estimation en heures pour les tâches, disant qu'il trouvait souvent superflu, tout spécialement lorsque vous avez un tableau des tâches montrant comment les choses se passent. Christofer disait qu'il avait trouvé l'estimation en heures utile pour décider quelle quantité de travail prendre `take on`, mais il revint tout de suite sur ces propos y compris parler sur les mauvaises choses (les heures plutôt que le travail) ou seulement en étant hors sujet `tune out`.
...
Certaines personnes étaient en faveur de l'estimation des tâches en heures et disaient qu'elles le faisaient généralement. Certains trouvaient cela utile pour de nouvelles équipes, comme l'indiquait Christofer.
...
D'autres étaient beaucoup moins favorables par rapport aux tâches, à l'estimation des tâches en heures, l'estimation des tâches du tout, ou à toute forme d'estimation. Je ne veux pas dire que cela correspondait à avoir raison, mais dans une grande majorité les gens qui étaient moins favorables étaient des personnes présentes sur la liste depuis longue date et dont les noms m'étaient familiers.
...
Peut-être voulaient-ils juste que les personnes sortent de leur terrier, mais je ne le pense pas. Je crois que l'expérience collective tend à révéler des choses qui sont probablement vrai, et qu'il est probable que l'estimation en heures soit loin de l'idéal.
...
Si nous avons estimé les tâches en heures, nous pouvons suivre le réalisé. Si elles diffèrent, il y évidemment quelque chose qui s'est mal passé. La question naturelle qui suit est "qu'est-ce qui s'est mal passé lors votre estimation ?". La réponse naturelle qui suit est de devenir meilleure sur l'estimation.
...
Vous obtenez alors ce que vous avez demandé. Ce que vous aurez ce sont des estimations suffisamment large pour qu'elles soient rarement dépassées. Cela aura comme conséquence que l'équipe prendra en charge moins de travail et que cela vous ralentira.
...
Faire le suivi des heures réelles par rapport aux heures estimées tend à conduire vers les ennuis. Est-ce si inévitable ? Certainement pas. De manière similaire, il n'est pas inévitable que si vous jouez au milieu de la route, que vous vous percutez par un camion.

### Burning down hours  burn down

### Les heures consommées

`Burning down hours is an inefficient way to track.`

`Suivre les heures consommées est manière inefficace de faire du suivi`
...
OK, nous n'essayons de faire se rejoindre l'estimé et le réel, mais nous utilisons l'estimation en heures du travail restant pour suivre les tâches de notre backlog. Si vous plissez des yeux juste ce qu'il faut, vous pouvez lire quelque chose dans le guide scrum qui vous dit de faire quelque chose qui y ressemble.
...
Suivre les heures consommées est OK, mais inefficace. Et avoir les heures conduit à les suivre à la fin du sprint, ce qui selon la section précédente , est loin d'être l'idéal.
