...
<div align="right" style="float:right; padding-left:30px">
  <img title="Groupe de JdR" src="{{ site.url }}assets/scrum_equipe_pjs/lunar-250x250.png" />
</div>
...
Si vous voulez ajouter quelque chose, n'hésitez pas à laissez quelques commentaires dans la zone commentaire. Rappelez-vous, une attitude positive et le partage de connaissances est la clé vers la réussite d'une équipe !
