...
**Excités d'essayer**
Comme la plupart des équipes que je connais, notre équipe se débat pour obtenir le bon niveau de détails sur les exigences de chaque user story avant que nous commencions à tester et à coder. Nous ne voulons pas faire de conception préalable, mais nous ne voulons pas perdre du temps à faire du va-et-vient avec le _product owner_ et les autres experts métiers pour fixer les spécifications pendant le développement. Des techniques de remues-méninges telles que les cartes heuristiques nous y ont aidé, mais nous ressentions toujours que nous perdions trop de temps avec la génération des exigences.
...
J'avais envie depuis quelques temps d'essayer la cartographie des stories et voir si elle pouvait nous aider à matérialiser les détails d'un thème et ses user stories en avance par rapport au développement. J'étais donc contente lorsqu'un après-midi notre _ScrumMaster_ vint me dire : "Nous voulons essayer la cartographie de stories pour le thème de demain 'Nous vous aidons à choisir'."
...
La chose que j'avais compris à propos de la cartographie des user stories était que toutes les parties prenantes doivent participer. Souvent, il nous manquait des parties prenantes importantes dans nos réunions d'estimations et de remues-méninges, aussi ai-je insisté pour que toutes les parties prenantes de ce thème soient présentes pour notre session de cartographie des stories. Dans ce cas, il s'agissait d'une seule personne, mais beaucoup des thèmes que nous gérions impliquaient de multiples parties prenantes.
...
Nous étions dix personnes dans la pièce. La première que j'oubliais fût que j'aurais dû les répartir en petits groupes de trois à cinq personnes et que chaque groupe travaille sur le thème. Oh oh.
...
J'ai commencé par poser des questions à nos experts métiers au sujet des personas pour le thème. Qui devrait l'utiliser ? La réponse fût les commerciaux. Malheureusement, nos parties prenantes ne connaissaient quasiment rien au sujet des commerciaux, donc nous ne pourrions pas vraiment refléter ce type de personnalité dans un persona. Ce n'était pas un bon commencement ! Tous ce que nous pourrions faire serait de l'appeler "Sammy le commercial" et dire qu'il était intéressé seulement par réaliser une vente.
...
Personne ne se leva de sa chaise. Si seulement j'avais pu me rappeler de la répartition en petits groupes ! Je répétais ma requête de manière plus assertive. Le _ScrumMaster_ se leva et vint se joindre à moi. Personne d'autre ne se leva. Après coup, je pense que j'aurais dû faire la cartographie des stories sur la table de conférence à la place de la faire sur le tableau, mais sur le moment je n'y pensais pas. 
...
Ayant abandonné le fait que les personnes se déplacent physiquement, je demandais, "Quelle est la première chose que Sammy le commercial ferait ?". Il va créer un plan `401(k)` pour un employeur. C'était une béquille multi-étape, afin que la frise temporelle paraisse assez évidente. J'écrivis "Étape 1" sur une note adhésive et je la mis sur le tableau blanc. Le commercial saisirait les informations concernant l'entreprise, puis sélectionnerait les options de contributions pour le plan, puis sélectionnerait les fonds mutualisés ou les options "Aidez-moi à choisir", et ainsi de suite.
...
Une fois que nous avons eu la frise temporelle pour ces tâches, nous avons pris du recul et nous sommes entrés dans les détails. Qu'est-ce qui changerait à chaque étape avec ce que font aujourd'hui les commerciaux lorsqu'ils créent un plan `401(k)`. Nous notâmes alors les détails nécessaires pour chaque page d'IHM et quelques exigences pour l'implémentation.
...
Malheureusement, nous avions commencé à un niveau trop détaillé. D'abord, nous aurions dû identifier les "activités utilisateurs" - les éléments haut niveau que font les utilisateurs pour accomplir un objectif donné. Établir un plan `401(k)` est une activité de l'utilisateur commercial. Gérer le regroupement des fonds est une activité utilisateur. Nous avions commencé avec les étapes spécifiques des "tâches utilisateurs" existantes au sein d'une activité utilisateur. "Sélectionner un regroupement de fonds" est une tâche utilisateur au sein de l'activité d'établir un plan `401(k)`.
...
J'avais aussi oublié que nous aurions dû parcourir la cartographie des stories avec les parties prenantes. C'est une manière de tester la carte et de trouver des détails supplémentaires. Bien sûr, maintenant que nous avions la cartographie, nous pourrions le faire plus tard.
...
Vers la fin de la réunion, j'ai su que j'avais fait plusieurs erreurs sur la cartographies des stories. J'ai présenté mes excuses à l'équipe, j'ai levé mes mains en faisant la forme d'un `"failure bow"`, et j'ai dit : "Comme c'est fascinant !". Je leur ai demandé d'applaudir à mon échec. J'ai espéré que aurions encore quelque chose à apprendre.
...
Lorsque la réunion a pris fin, je suis revenu sur mes notes à propos de la cartographie des stories et j'ai trouvé ce que j'avais râté. Je suis revenu vers le tableau blanc et j'ai ajouté les notes adhésives pour la ligne "activité utilisateur" manquante. (Nous avions des activités utilisateur implicites, mais nous ne les avions pas spécifié sur le tableau blanc). J'ai colorié certains détails selon un code couleur en dessous chaque tâche utilisateur pour indiquer lesquelles étaient des implémentations techniques, lesquelles étaient des questions importantes, et lesquelles étaient des tâches connues. Et maintenant, cela ressemblait plus à une cartographie de stories (voir figure 1).
...
J'ai demandé à mes co-équipiers leur feedback sur notre tentative de "cartographie de la story " quelque peu raté. Étant donné que nous ne savions pas comment la cartographie des stories était censé fonctionner, ils étaient OK avec ça. Ils avaient ressenti que nous avions mis en lumière certains détails sur les stories sur ce thème que nous n'aurions pas vu autrement jusqu'au moment de coder.
...
**La prochaine fois**
Nous avons commencé à travailler sur les user stories de ce thème le sprint d'après. Nous avons ressenti que nous commencions avec une meilleure compréhension commune de ce que nous faisions d'habitude pour un nouveau thème. Nous avons découpé le thème en user stories de taille appropriée et nous avons compris leurs dépendances. Toutefois, une certaine confusion sur une partie du modèle concernant des relations implicites survint et qui provoqua quelques heures perdues en temps et en discussion.  C'est justement ce que nous tentions d'éviter avec la cartographie des stories, et cela arrivait encore. C'était très frustrant.
...
Même les échecs nous aide à apprendre, je suis heureuse d'avoir vu mes erreurs et de les avoir reconnues plutôt que d'être découragée. Nous nous améliorons en essayant des expériences, et l'équipe est d'accord pour continuer dessus. Je vous tiendrai au courant !
