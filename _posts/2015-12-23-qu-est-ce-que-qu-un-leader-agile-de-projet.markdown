...
Qu’est-ce qu’un leader agile de projet ?

I wrote this article because of two observations:

Cet article a été écrit en raison de deux observations :
...
1. **Beaucoup d’organisations utilisent un “mode projet” lorsqu’elles ne devraient pas.**
2. **Il y a beaucoup de confusions et de débats dans la communauté agile au sujet des projets et du leadership des projets.**
...
Je ne prétends pas avoir “la réponse”, mais j’y ai beaucoup réfléchi et expérimenté sur mes clients (ne leur dites pas … sshhhh). Par conséquent, voici mon point de vue sur le leadership de projet dans un contexte agile.
...
Ah au fait, en passant, cet article est un `Bait & Switch`. Je suis en train d’essayer de vous faire lire [Qu’est-ce qu’un leader agile ?]`()`. Vous pourriez vous économisez beaucoup de temps en vous arrêtant ici et allez là-bas tout de suite :)
...
Alors qu’arrivent-ils aux chefs de projets ? Ne sont-ils plus nécessaire ?
...
Faux ! **La gestion de projet n’a pas disparu, elle est juste redistribuée.** La chose que nous gérons est le produit, pas un projet, et la gestion est bien trop importante pour être laissé dans les mains d’une seule personne. Dans Scrum, par exemple, le rôle du chef de projet est délibérément scinder en deux rôles — le _product owner_ (qui se concentre sur le produit), et le _scrum master_ (qui se concentre sur l’équipe), et l’équipe elle-même qui se gère elle-même plutôt qu’“être géré” par un chef de projet. Donc, **la majorité de la “gestion de projet” existe toujours mais d’une manière différente — majoritairement décentralisé. Qu’en est-ils de projets ? Devrions-nous abandonner ce mode complètement ?**
...
**ÇA pourrait valoir le coup de les traiter comme un “projet”** — tout spécialement s’il s’agit d’un effort temporaire plutôt que quelque chose de continu. De manière basique, si la chose dans sa globalité à une “définition de fini” alors peut-être qu’il s’agit d’un projet.
...
* **Mythe :** “Mais nous sommes agiles et auto-organisés, toutes ces équipes vont se coordonner par magie les unes avec les autres et restent synchrones sans avoir besoin d’un leader !”
  * **Mon expérience :** Là probablement vous vous moquez de vous. Ou alors vous êtes peut être la rare exception.
...
* **Mythe :** “Un chef de projet signifie du micromanagement top-down et des processus big bang en cascade.”
  * **Mon expérience :**Seulement si le chef de projet n’est pas devenu agile. Sélectionnez la bonne personne pour le boulot (cet article va heureusement vous y aider !)
...
* **Mythe :** “Tous les projets doivent être agiles”
  * **Mon expérience :** Pas nécessairement. Si le travail est complexe et innovant, alors oui. Si nous-faisons-démarrer-des-petits-gadgets-et-que-nous-avons-fait-cela-des-douzaines-de-fois-avant, alors probablement non. La plupart des développements de produits tombent dans la première catégorie. Mais mon point de vue est biaisé toutefois, j’ai travaillé la plupart du temps avec des entreprises dont le développement des produits est basé sur l’innovation.

So, in short: **don’t use projects for everything – but when you do, make sure you have an awesome Agile Project Leader!**

Donc, pour faire court : **N’utilisez pas le projet pour n’importe quoi — mais quand vous le faites, soyez certain d’avoir un leader agile de projet !**
...
Cela a commencé comme un article sacrément long. Puis j’ai réalisé que le rôle que j’étais en train de décrire était en réalité sur le leadership agile en général, et pas seulement sur le mode projet en particulier.
...
* [What is an Agile Leader](http://blog.crisp.se/2015/11/10/henrikkniberg/what-is-an-agile-leader)
...
**Allez-y et lisez cet article**, et insérez le mot “projet” là où cela aura du sens. Je vous l’ai dit cet article est un `bait & switch.`:)
...
Il y a certaines choses qui peuvent être différents dans un contexte de projet — par exemple l’aspect “agent du changement”. Par définition, un projet est quelque chose de différents de votre travail “quotidien habituel”, et implique probablement la collaboration entre les équipes et les services qui ne travaillent pas normalement ensemble. Malheureusement, étant donné que nous parlons des personnes, cela signifie une certaine dose de politique et de diplomatie. D’où **la nécessité our un chef de projet de devoir gérer les limites organisationnelles (et culturelles)** soit en franchissant ces limites ou en améliorant la collaboration au-delà de ces limites. C’est un boulot difficile, donc n’oubliez pas de donner à vore chef de projet une tape dans le dos de temps en temps.
...
Remarquez bien qu’il s’agit de mon avis personnel, ma vision de ce qu’est un _leader agile de projet_ (ou devrait être). Certaines personnes peuvent ne pas être d’accord, cela me va. Je suis aussi heureux d’avoir du _feedback_, même si je n’aurai pas la même disponibilité pour y répondre.

(Why are you still here? Go read [What is an Agile Leader!]((Why are you still here? Go read What is an Agile Leader!)))
